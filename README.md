⚡ APEX-SEC | Next-Gen AI Cyber Operations & Threat Intelligence Suite
<div align="center">
   █████╗ ██████╗ ███████╗██╗  ██╗    ███████╗██████╗ ██╗
  ██╔══██╗██╔══██╗██╔════╝╚██╗██╔╝    ██╔════╝██╔══██╗██║
  ███████║██████╔╝█████╗   ╚███╔╝     ███████╗██████╔╝██║
...
Intelligence CISA KEV

🔬 Overview • 🚀 Core Capabilities • 💻 System Requirements • ⚡ Installation • 🎯 Execution • ⚖️ Disclaimer
</div>
🔬 Overview
...
🪟 Windows Setup (Command Prompt as Administrator)
...
> ⚠️ CRITICAL: Once the model finishes loading and displays >>>, minimize this Command Prompt window. Maintain this process running in the background.
> 
Step 7: Install Python Project Dependencies
...
> Note: Keep this terminal session active or run it as a background service.
> 
...
Open your terminal or Command Prompt and navigate to the directory containing apex_sec.py:
 * Windows:
   cd Desktop
...
If operating on Linux or Kali Linux, assign execution permissions to the script:
chmod +x apex_sec.py

Step 3: Launch Tactical Command Suite
Execute the Streamlit runtime engine:
streamlit run apex_sec.py

Step 4: Access Web Application Interface
Your default browser will launch automatically. Alternatively, access the local instance at:
http://localhost:8501
